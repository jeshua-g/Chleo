...
export type EmotionFamily =
  "joyful" | "aggressive" | "sad" | "surprised" | "fearful" | "neutral";
 ...
 */
export const EXPLICIT_PAIR_OVERRIDES: Partial<
  Record<string, EmotionFrameConfig>
> = {
...
export function getAvatarEmotionFrames(
  ...
  const familyMap =
    COMBINED_FAMILY_RESPONSE_MAP[family] ??
    COMBINED_FAMILY_RESPONSE_MAP.neutral;
